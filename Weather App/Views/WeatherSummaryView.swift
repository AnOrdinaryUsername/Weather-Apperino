                ...
                GeometryReader { geometry in
                    VStack(spacing: 14) {
                        if let weatherInfo = location.weatherData {
                            ...
                            RowBoxView {
                                VStack(spacing: 6) {
                                    RowView(columnOne: "High Temp", columnTwo: "\(roundAndRemoveDecimals(weatherInfo.main.tempMax))°F")
                                    
                                    RowView(columnOne: "Low Temp", columnTwo: "\(roundAndRemoveDecimals(weatherInfo.main.tempMin))°F")
